...
from users.api.v1.views import (
    ...
    RequestPhoneOtpView,
    UserPhoneVerifyView,
    GoogleAuthenticateView,
    GoogleDissociateView
)
...
urlpatterns = [
    ...
    path('users/authenticate_google/', GoogleAuthenticateView.as_view()),
    path('users/dissociate_google/', GoogleDissociateView.as_view())
]
